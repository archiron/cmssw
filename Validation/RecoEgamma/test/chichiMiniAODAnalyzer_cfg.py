...
## Launch cmsRun chichiMiniAODAnalyzer_cfg.py ZEE_14
...
#dd_tier = 'MINIAODSIM'
tag_startup = 'mcRun3_2021_realistic_v10' #'113X_mcRun4_realistic_v7_2026D76noPU'
global_tag = 'mcRun3_2021_realistic_v10' #'113X_mcRun4_realistic_v7'
data_version = 'v1'
...
process.GlobalTag.globaltag = global_tag # '113X_mcRun4_realistic_v7'
...
process.load("Validation.RecoEgamma.chichiMiniAODAnalyzer_cfi")
...
process.chichiMiniAODAnalyzer.InputFolderName = cms.string("EgammaV/chichiMiniAODAnalyzer")
process.chichiMiniAODAnalyzer.OutputFolderName = cms.string("EgammaV/chichiMiniAODAnalyzer")

process.p = cms.Path( process.chichiMiniAODAnalyzer * process.MEtoEDMConverter )
#process.p = cms.Path( process.miniAODElectronIsolation * process.ElectronIsolation * process.chichiMiniAODAnalyzer * process.MEtoEDMConverter )
